...
class ResourceSafetyExercisesTests extends BaseTestSuite {
  test("ResourceSafetyExercises.ex1") {
    ...
    val f1             = ResourceSafetyExercisesSolutions.ex1(successfulTask).runToFuture
    f1.value shouldEqual Some(Success(20))

    val dummy      = DummyException("dummy")
    val failedTask = Task.raiseError(dummy)

    val f2 = ResourceSafetyExercisesSolutions.ex1(failedTask).runToFuture
    s.tick(1.second)
    ...
    val f3           = ResourceSafetyExercisesSolutions.ex1(canceledTask).runToFuture
    f3.cancel()
  ...
  test("ResourceSafetyExercises.ex2") {
    ...
    val f1 = ResourceSafetyExercisesSolutions.ex2(() => inputStream).runToFuture
    ...
    val f2 = ResourceSafetyExercisesSolutions.ex2(() => inputStream2).executeAsync.runToFuture
    ...
    val f3 = ResourceSafetyExercisesSolutions.ex2(() => failingInputStream).runToFuture
  ...
  test("ResourceSafetyExercises.ex3") {
    ...
    val f1 = ResourceSafetyExercisesSolutions.ex3(() => inputStream).runToFuture
