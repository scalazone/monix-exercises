...
class ConcurrencyExercisesTests extends BaseTestSuite {
  test("ConcurrencyExercises.ex1") {
    ...
    val f = ConcurrencyExercisesSolutions.ex1(a, b).runToFuture
  ...
  test("ConcurrencyExercises.ex2") {
    ...
    val f = ConcurrencyExercisesSolutions.ex2(tasks).runToFuture
  ...
  test("ConcurrencyExercises.ex3") {
    ...
    val f = ConcurrencyExercisesSolutions.ex3(tasks).runToFuture
