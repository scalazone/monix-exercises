...
class TransformationExercisesTests extends BaseTestSuite {
  ...
  test("TransformationExercises.ex1") {
    ...
    val f = TransformationExercises.ex1(a).runToFuture
  ...
  test("TransformationExercises.ex2") {
    ...
    val f = TransformationExercises.ex2(a, b).runToFuture
  ...
  test("TransformationExercises.ex4") {
    ...
    val f = TransformationExercises.ex4(numbers.map(Task.now)).runToFuture
  ...
  test("TransformationExercises.ex5") {
    ...
    val f = TransformationExercises.ex5(numbers, compute).runToFuture
  ...
  test("TransformationExercises.ex6") {
    ...
    val f = TransformationExercises.ex6(() => compute).runToFuture
  ...
  test("TransformationExercises.ex7 should return after value > n") {
    ...
    val f = TransformationExercises.ex7(task, 3, 1000).runToFuture
  ...
  test("TransformationExercises.ex7 should return after maxRetries is reached") {
    ...
    val f = TransformationExercises.ex7(task, 1000, 10).runToFuture
